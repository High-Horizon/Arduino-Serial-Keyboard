...
1. Install or Run all the files inside th "Redist" folder. (Skip this step if all the softwares are already installed)
2. Double Click on the windows batch files "pyserial.bat" & "pyautogui.bat". This is to install the reqired libraries.
3. 
4. Double Click on "ArdToKey.ino" file & upload the sketch to your Arduino.
5. Run the "Start_Serial_Keyboard.bat" file.
6. Done, enjoy...!!
